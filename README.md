...
- **Lightning Strikes can spawn enemies**: Lightning Strikes have a 50% probability of making a Golden or Seized enemy appear. Once it's determined an enemy must appear, it has 20% chance of being a Golden Bokoblin, 15% Golden Moblin, 15% Golden Lizalfos, 15% Golden Horriblin, 7% Golden Boss Bokoblin, 15% Seized Soldier Construct, 10% Seized Captain Construct, 3% Golden Lynel. (__recommended__)
...
##### On Yuzu (and forks)
- Download the version of the mod that you want. (e.g. if you want the recommended build, download `challenge_mode_180_recommended.zip`).
