...
Depths of the Kingdom: [Download compatibility patch](https://github.com/Echocolat/TOTK-Master-Mode/blob/main/Tkcl%20files/CM%201.7.5%20x%20DotK%201.2.0%20Compatibility%20Patch.tkcl?raw=true) - *Target version is 1.2.0*
...
##### On Yuzu (and forks)
- Download the version of the mod that you want. (e.g. if you want the recommended build, download `challenge_mode_175_recommended.zip`).
